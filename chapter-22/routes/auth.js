...
authRouter.post("/logout",async(req,res)=>{
   try{
       ...
       // way1 -> send invalid token
       // res.cookie("token","dfebgdafgbdev")
       // res.send("logout successfull")

      // way2 -> expire cookie -> clear cookie and token too
      res.cookie("token",null,{expires:new Date(Date.now())}); // frontend ko bolray hai ki cookie delete kardo abhi turant 
      res.send("logout successfull")
